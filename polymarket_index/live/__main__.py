...
Examples:
  ...
  python3 -m polymarket_index.live --resume
    ...
    parser.add_argument("--top-n", type=int, default=50, help="Copy trades from top N scored wallets (default: 50)")
    ...
    parser.add_argument("--min-price", type=float, default=0.10, help="Min price to copy (default: 0.10)")
    parser.add_argument("--max-price", type=float, default=0.92, help="Max price to copy (default: 0.92)")
    parser.add_argument("--min-score", type=float, default=55.0, help="Min wallet score to consider (default: 55)")
